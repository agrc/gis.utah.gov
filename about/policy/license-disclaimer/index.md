...
- standards-compliant and/or [search engine-optimized (SEO) metadata]({% link sharing/metadata/index.md %}), where available, be included with any distribution of all geospatial data
