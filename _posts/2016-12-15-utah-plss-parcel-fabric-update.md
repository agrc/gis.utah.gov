...
Since we are now doing all work on the PLSS/GCDB and CadNSDI in the fabric enviorment and the current version is a starting point, a new begining we are going to be calling this data **Utah PLSS Fabric V1**
Sorry for any confusion this may have caused, this V1 is the original fabric no adjustments using local data have been made yet, as we do updates now we will build up from V1.
