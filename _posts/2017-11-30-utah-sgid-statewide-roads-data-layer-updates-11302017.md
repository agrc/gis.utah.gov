...
Updates were recently made to the SGID10.Transportation.Roads and [SGID10.Transportation.RoadsODM]({% post_url 2017-08-15-major-updates-coming-to-roads-data-model %}) feature classes that reside on the [Utah SGID ArcSDE database server]({{ "/sgid-database/" | prepend: site.baseurl }}).
