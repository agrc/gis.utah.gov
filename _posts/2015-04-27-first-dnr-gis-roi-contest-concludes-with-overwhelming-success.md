...
<figure class="caption caption--right"><img class="caption__image" src="{{ "/images/GIS-Award-DNR-ROI.jpg" | prepend: site.baseurl }}" alt="ned" width="500" height="333" /><figcaption class="caption__text">DNR Executive Director Mike Styler with GIS contest finalists Tanna Fullenkamp, Kent Brown, Aaron Austin, Rachel Williams, Ben Sutter and Avery Cook</figcaption></figure>
