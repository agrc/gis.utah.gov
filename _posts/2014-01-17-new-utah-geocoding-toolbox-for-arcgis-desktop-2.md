...
<p><a href="{% link images/geocodetoolbox.png %}"><img src="{% link images/geocodetoolbox.png %}" alt="" title="geocodetoolbox" width="600" height="345" class="aligncenter size-full wp-image-14332" /></a></p>
