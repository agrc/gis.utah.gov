...
![Existing Bike Features]({% link images/20200527_ExistingBikeFeatures.jpg %} "click to enlarge")]({% link images/images/Existing Bike Features Example Big.png %}){:.inline-text-right .outline }
...
![Planned Bike Features]({% link images/20200527_PlannedBikeFeatures.jpg %} "click to enlarge")]({% link images/images/Planned Bike Features Example Big.png %}){:.inline-text-right .outline }
