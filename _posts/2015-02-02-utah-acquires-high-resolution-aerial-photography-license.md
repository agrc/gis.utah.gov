...
<a href="{{ "/downloads/umiplogos.png" | prepend: site.baseurl }}"><img src="{{ "/images/umiplogos-800x290.png" | prepend: site.baseurl }}" alt="" title="Google Imagery Acquisition partner Agencies" width="450" height="162" class="inline-text-left"/></a></p>
