...
In the near future, AGRC will also offer a public-facing, PostgreSQL cloud database where users can make direct connections from their desktop client.  This will bring new functionality as well as an additional access point for our end users.  We are excited about this offering so keep an eye on our [Twitter](https://twitter.com/maputah) or [newsletter](https://gis.utah.gov/news/#mc_embed_signup) for upcoming details.  

Additionally, AGRC has established a workflow with our partner agencies to serve their authoritative data through AGOL.  Essentially, their SGID-relevant data is cataloged and discoverable on AGRC’s official AGOL page.  We like to think of it as a live window into their data.  One of the biggest benefits to our users is that this data no longer has a shelf life: in other words, the updates they make are available instantaneously.  Currently, we are set up with [State History](https://history.utah.gov/) and [Water Rights](https://www.waterrights.utah.gov/).  We are working to get other agencies on board in the coming months.
