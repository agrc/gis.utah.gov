...
<figure class="caption caption--right"><a href="{{ "/downloads/HRO2012_footprint.png" | prepend: site.baseurl }}"><img class="caption__image" style="border: 1px solid black;" title="HRO2012 Footprint (click to enlarge)" src="{{ "/images/HRO2012_footprint.png" | prepend: site.baseurl }}" alt="" width="150" height="248" /></a><figcaption class="caption__text">HRO2012 Footprint (click to enlarge)</figcaption></figure></li>
