...
<p><em><strong>Important NG9-1-1 GIS data layers include:</strong></em><a href="{{ "/gallery/sgid/utah-gis-streets-roads.png" | prepend: site.baseurl }}"><img src="{{ "/images/gallery/sgid/utah-gis-streets-roads.png" | prepend: site.baseurl }}" width="90" height="90" class="inline-text-left" /></a></p>
<ul>
<li>
...
<li>Utah's first release of a statewide <strong><em><a href="{{ "/data/location/address-data/" | prepend: site.baseurl }}">address points</a></em></strong> <a href="{{ "/downloads/Addresspntmapservice.png" | prepend: site.baseurl }}"><img src="{{ "/images/Addresspntmapservice-150x150.png" | prepend: site.baseurl }}" alt="" title="Addresspntmapservice" width="90" height="90" class="inline-text-left" /></a>GIS layer was in June 2013 and most counties are close to if not complete. An update is expected in early January 2014. While address points are strongly recommended (not required) for the NG9-1-1 environment, a more frequent update cycle is suggested for this dataset too.<br />
</br>
</li>
<li><strong><em><a href="{{ "/data/location/address-data/" | prepend: site.baseurl }}">Addressing system boundaries</a></em></strong><a href="{{ "/downloads/Grids.png" | prepend: site.baseurl }}"><img src="{{ "/images/Grids-150x150.png" | prepend: site.baseurl }}" alt="" title="Grids" width="90" height="90" class="inline-text-left" /></a> (often referred to as 'address grids' in Utah) and their relationship to <em><strong>informal placenames</strong></em> are also important since addresses will need to be found across large regions or statewide using community name or informal placenames to focus the search.<br />
</br>
</li>
<li>The GIS representation of <strong><em><a href="{{ "/data/society-overview/public-safety/" | prepend: site.baseurl }}">PSAP jurisdictional boundaries</a></em></strong> have been maintained by AGRC for the Utah 9-1-1 Committee since 2005 <a href="{{ "/downloads/PSAPBndy2.png" | prepend: site.baseurl }}"><img src="{{ "/images/PSAPBndy2.png" | prepend: site.baseurl }}" alt="" title="PSAP Boundary" width="90" height="90" class="inline-text-left" /></a>in order to track the enhanced 9-1-1 (e9-1-1) build out initiative and related grant funding. Existing emergency service number zones (ESNs) have, for the most part, not yet been mapped in Utah but can be derived into a GIS format from information in the MSAG tables as needed.<br />
</br>
</li>
<li>A <strong><em><a href="{{ "/data/sgid-transportation/roads-system/" | prepend: site.baseurl }}">highway system route and milepost</a></em></strong> <a href="{{ "/downloads/Utah-SGID-Highway-Milepost.png" | prepend: site.baseurl }}"><img src="{{ "/images/Utah-SGID-Highway-Milepost.png" | prepend: site.baseurl }}" alt="" title="Utah SGID Highway Milepost" width="90" height="90" class="inline-text-left" /></a>GIS dataset has been maintained in partnership with UDOT since 2009 and includes the ability to look up any milepost-based location reference ("I'm at milepost 210 on I-15") and to display exit number as well as mileposts (for every 1/10th of a mile) on 9-1-1 call-taker and dispatcher screens. This resource is likely not a direct asset to 9-1-1 call routing but may be helpful to call takers as they work to verify incident locations, especially for roadside mobile callers.</li>
<p>Resources:</p>
