...
If you’re reading this post, you’re already aware that Geospatial technology (a.k.a. GIS) has become an essential part of our daily lives. Its capabilities extend from small-scale phone applications all the way up to multibillion dollar businesses systems, including big tech, insurance, intel and healthcare industries, just to name a few. As a result, the distinction between information technology and GIS is fading fast. This is exciting because as geospatial technology goes mainstream, we are seeing a wider array of uses for it—and often, the map is nowhere to be seen. It’s often mapless, or invisible geospatial data and intelligence that’s driving these systems.
