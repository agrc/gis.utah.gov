...
<ul>
<li><a href="{{ "/data/address-data/" | prepend: site.baseurl }}">SGID10.Location.AddressPoints</a></li>
</ul>
...
<ul>
<li>The statewide address point layer is now being used as reference data for the <a href="{{ "/utah-statewide-address-geocoding-web-service-upgrade/" | prepend: site.baseurl }}">api.mapserv.utah.gov</a> address locators</li>
