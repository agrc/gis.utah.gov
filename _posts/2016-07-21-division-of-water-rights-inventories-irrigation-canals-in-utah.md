...
<img class="caption__image" src="{{ "/images/CanalInventory.jpg" | prepend: site.baseurl }}" alt="Canal Inventory Status Map" /></a>
...
<figure class="caption caption--right">
<img class="caption__image" src="{{ "/images/CanalAerialImageryExample.jpg" | prepend: site.baseurl }}" alt="Canal on High Res Imagery" />
