...
<figure class="caption caption--right"><a href ="{% link images/BLMgeopdfs3.png %}"><img class="caption__image" src="{% link images/BLMgeopdfs3_small.png %}" alt="GeoPDF on Hike in Moab" /></a><figcaption class="caption__text"> Management Analyst Lissa Eng from the WO compares a draft Geo PDF map to her surroundings during a hike in Moab, Utah.
</figcaption></figure>
