...
<figure class="caption caption--right"><a href ="{{ "/images/BLMgeopdfs3.png" | prepend: site.baseurl }}"><img src="{{ "/images/BLMgeopdfs3_small.png" | prepend: site.baseurl }}" alt="GeoPDF on Hike in Moab" /></a><figcaption class="caption__text"> Management Analyst Lissa Eng from the WO compares a draft Geo PDF map to her surroundings during a hike in Moab, Utah.
</figcaption></figure>
