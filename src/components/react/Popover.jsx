...
export default function Popover({ trigger, children, open = false, isModal = false }) {
  return (
    <RadixPopover.Root defaultOpen={open} model={isModal}>
      {/*
          ...
          contains a button.
        */}
      <RadixPopover.Trigger asChild={isValidElement(trigger)}>{trigger}</RadixPopover.Trigger>
      <RadixPopover.Portal>
