...
export const SITE_TITLE = 'Utah Geospatial Resource Center : GIS Portal';
...
export const MENU_CSS =
  'flex group select-none items-center justify-between gap-[2px] transition-colors duration-300 hover:bg-zinc-400/20 hover:text-zinc-900 rounded-full relative block py-1 px-4 text-sm lg:text-base font-medium text-zinc-600';
