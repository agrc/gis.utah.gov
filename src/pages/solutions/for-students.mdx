...
<Layout title={frontmatter.title}>
  <Section stripe title="Solutions for Students">
  ...
  <Section stripe title="Base Maps and Imagery">
    ...
    Does your research project have you counting trees in aerial imagery? Or do you have data ready to map and just need a clean canvas to put it on? Our <a href="/products/discover/">Discover</a> base map and imagery web services provide access to both aerial imagery and our set of gorgeous <a href="/data/basemaps/">base maps</a> that you can use in both static and web maps.
  ...
  <Section stripe title="Jobs and Internships">
  ...
  <Section stripe title="Citations">
