...
<Layout title={frontmatter.title}>
  ...
  <QuickLinks links={frontmatter.quickLinks} slot="quick-links" />
    ...
    - DHHS cooling towers
    - Roadkill mobile app
    - WRI or another business process app

    With hundreds of years of combined experience in the geospatial world, we've seen and done a lot. No partnership is too big or small, and getting in touch with us early in your process often ensures the greatest return on your investment and the easiest pathway to success.
