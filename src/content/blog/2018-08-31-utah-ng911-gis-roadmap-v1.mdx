...
- Provide Utah's statewide [NG911 GIS database](/solutions/for-emergency-response/);
...
- Ensure that required GIS datasets adhere to NENA NG911 Data Model specifications;
  - UGRC will look for discrepancies and inconsistencies in the aggregated statewide [NG911 GIS Database](/solutions/for-emergency-response/) and report discrepancies back to the data providers [section 5.4.3 of ref 5)](#further-reading); and
...
Be proactive and get involved now. For more information contact <Contacts inline subject={frontmatter.title} contactKey='roads' />.
