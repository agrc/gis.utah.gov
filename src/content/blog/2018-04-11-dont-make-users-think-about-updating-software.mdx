...
import ThreeColItem from '../../components/ThreeColItem.astro';
...
<ThreeCol cols={3} gap="gap-6" class="my-6">
  <ThreeColItem>
...
The evergreen documentation is in the repository [read me](https://github.com/steveoh/pro-evergreen/blob/main/README.md) and getting started with Pro Evergreen is 10 steps or fewer.
...
1. Compare the versions to see whether the add-in is current `evergreen.IsCurrent(addinVersion, gitHubVersion);`
...
![ProEvergreen](https://github.com/steveoh/pro-evergreen/raw/main/proevergreen.png)
