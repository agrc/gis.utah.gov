...
For those of you who would prefer to access the State Geographic Information Database (SGID) via ESRI’s ArcGIS Desktop software rather than ArcGIS Online or downloads from gis.utah.gov, you’re in luck. UGRC is testing a public connection to an instance of the SGID hosted in the Amazon cloud.
...
<Contacts subject={frontmatter.title} contactKey="sgid" />
