---
title: OGM Oil and Gas Wells Data Update
published: false
author: Scott Davis
...
<Contacts subject={frontmatter.title} contactKey="oil_wells" />

More information can be found on the [Oil and Gas data resource page](/products/sgid/energy/).
