...
<p><a href="/images/404.png"><img src="/images/404.png" alt="" title="Click to enlarge" width="800" height="227" class="" loading="lazy" /></a></p>
...
<p>Please note that the agreement only needs to be completed once for each organization and that contractors working only within the physical facilities or network of immediate licensees, do not need complete the Agreement.</p>
...
<p>Get started by getting a primary contact designated for your organization and sign up using the Organizational Usage Agreement.</p>
