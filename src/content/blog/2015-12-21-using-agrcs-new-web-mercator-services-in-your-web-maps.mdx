...
<p class="text-center pop">
  The instructions on this page are dated. <a href="/documentation/discover/clients">Using Discover services with the Esri JavaScript API v4.x</a> contains more current information.
</p>
...
<p>You’ll notice that the URL to the service includes a quad word that is unique to your organization and project. If you don’t have an account set up or a quad word, you can <a href="/documentation/discover/licensed-imagery">register on our website</a> to get started.<strong> If you are planning on putting your quad word into a website or somewhere that it is publicly accessible, you will need to contact <Contacts inline subject={frontmatter.title} contactKey='discover' /> to receive a special quad word for licensing reasons.</strong> </p>
