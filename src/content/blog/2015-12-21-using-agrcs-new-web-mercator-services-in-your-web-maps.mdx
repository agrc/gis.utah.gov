...
<p>
  ...
  <strong>
    {' '}
    If you are planning on putting your quad word into a website or somewhere that it is publicly accessible, you will
    need to contact <Contacts inline subject={frontmatter.title} contactKey="discover" /> to receive a special quad word
...
<p>
  ...
  is cached to level 19 and then the Google imagery service is added, the map will not allow you to zoom into level 20.{' '}
</p>
<p>
