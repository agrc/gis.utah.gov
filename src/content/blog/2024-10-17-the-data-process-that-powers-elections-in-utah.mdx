...
With the cool winds blowing in, fall is officially upon us. That means a few things: warm sweaters, yellow aspen trees, and everyone's favorite method of acquiring a free sticker: voting! Election Day will be on Tuesday, November 5th, 2024. If you aren't registered to vote, you can learn how over on [vote.utah.gov](http://vote.utah.gov). Once you're registered, you can either vote by mail or in person. In both cases, where you vote and how your vote is counted are determined by geospatial data maintained by UGRC and local government authorities.

UGRC might not be able to make the beautiful autumn hues of red, orange, and yellow stay longer than their natural time, but we are charged with safekeeping the data that makes elections in Utah possible. An example of these data are the digital polygon representations of voting precinct boundaries. Maintaining these boundaries requires collaboration, organization, and a great attention to detail. Part of [our mission](https://gis.utah.gov/about/) as geospatial leaders in Utah is to “ensure a high level of coordination among Utah GIS users and effective, efficient use of GIS resources.” And boy oh boy, does making elections happen demand a lot of coordination. So, let's take a moment and get to know what's involved with keeping the data side of democracy alive.
