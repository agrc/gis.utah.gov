...
- It has a different license - instead of our usual [CC BY 4.0](/documentation/policy/license-disclaimer) license, it carries the [ODbL 1.0](https://opendatacommons.org/licenses/odbl/summary/) license
...
Let us know what you think and reach out to <Contacts inline subject={frontmatter.title} contactKey='os_places' /> or on Twitter ([@maputah](https://twitter.com/maputah)).
