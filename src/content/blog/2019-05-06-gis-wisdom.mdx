...
tags:
  ...
  - education
  - best practices
cover_image: /src/images/pillar-blog/2019-05-06-gis-wisdom/gis_wisdom.png
cover_image_alt: GIS Wisdom
---
...
Explore some of the [existing GIS open data](https://hub.arcgis.com/pages/open-data) or consider contributing to the [Open Street Maps project](https://www.openstreetmap.org/about).
...
Drop me an email if you can think of other forms of GIS wisdom. I'll start a running list and post them below. My contact info is <Contacts subject={frontmatter.title} contactKey='roads' />.
