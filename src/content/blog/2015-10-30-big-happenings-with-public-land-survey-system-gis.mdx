...
cover_image: /src/images/pillar-blog/2015-10-30-big-happenings-with-public-land-survey-system-gis/comarker_large.jpg
cover_image_alt: marker
---

import Contacts from '@components/page/Contacts.astro';

![marker](../../images/pillar-blog/2015-10-30-big-happenings-with-public-land-survey-system-gis/comarker_large.jpg)

Good things are happening in Utah regarding the Public Land Survey System (PLSS), also known as the township, range, and section grid, which forms the foundation for GIS map representations of public and private lands and other related Utah map layers.
...
<Contacts subject={frontmatter.title} contactKey="plss" />
