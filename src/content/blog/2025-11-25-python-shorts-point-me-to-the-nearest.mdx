...
A line pointing from each temperature reading to it's associated address point would make comparing the points visually a breeze. However, there's not an intuitive way to create this using the normal near analysis tools.
