...
If you've ever used our broadband service layer, you'll know it's rather unwieldly. Today, in partnership with the Utah Broadband Center (UBC), **we're excited to announce a new version of residential broadband service areas that are easier to use and more accurately reflect service availability.** This layer answers the question "what service is available from whom in which areas?"

![Highly-detailed broadband coverage areas in Salt Lake, Utah, Wasatch, Sanpete, and Carbon Counties](/src/images/pillar-blog/2025-11-04-new-broadband-service-data/state-overview.png)
...
Our previous broadband service layer got its data from two sources: many providers responded to the UBC's twice-yearly request for coverage data, while for other providers we would download the data they submitted to the FCC under the old [Form 477](https://www.fcc.gov/general/broadband-deployment-data-fcc-form-477).
...
![A mess of complicated overlapping geometries](/src/images/pillar-blog/2025-11-04-new-broadband-service-data/existing-layer.png)
...
![The old map showing large swathes of land claimed as served that don't make sense](/src/images/pillar-blog/2025-11-04-new-broadband-service-data/existing-map.png)
...
![Fabric points located on every structure](/src/images/pillar-blog/2025-11-04-new-broadband-service-data/fabric-points.png)
...
**One benefit of the BDC is its built-in feedback mechanisms**. Individuals, governments, and providers can all submit challenges about either the fabric (whether or not a specific location is a BSL) or the service claimed at a given BSL.
...
![The fabric points for a single provider overlaid with the H3 level 8 hexagons that contain them](/src/images/pillar-blog/2025-11-04-new-broadband-service-data/points-to-hexes.png)
...
![The hexagons from the previous step dissolved into a single geometry](/src/images/pillar-blog/2025-11-04-new-broadband-service-data/dissolved-hexes.png)
