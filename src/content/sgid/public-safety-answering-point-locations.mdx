---
title: Utah Public Safety Answering Point Locations
category: Society
secondaryCategory: '911'
stewards:
  - UGRC
type: Point GIS data
lastUpdate: January 12, 2024
description: |
  PSAP Locations represent the primary Public Safety Answering Point (PSAP) locations in Utah.
  The Salt Lake County Sheriff Office PSAP is secondary.
  The original dataset was created in December 2004 by geocoding the PSAP addresses provided by the E911 Executive Committee.
hub:
